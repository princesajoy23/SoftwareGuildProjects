 ...
 * 
 */
public class UserIOConsoleImpl implements UserIO { //console-specific implementation of the UserIO interface.

    //this one is from Class Roster code along
    //software guild provided
